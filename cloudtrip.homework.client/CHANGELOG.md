...
- Create Angular project with ng: `ng new cloudtrip.homework.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`cloudtrip.homework.client.esproj`).
